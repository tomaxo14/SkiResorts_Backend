...
import com.example.skiResorts.service.ResortService;
...
public class ResortController {
    ...
    public ResponseEntity<?> preferredResorts(@RequestParam int blue, @RequestParam int red, @RequestParam int black,
                                              @RequestParam int snowPark, @RequestParam int location,
